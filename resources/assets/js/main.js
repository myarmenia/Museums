...
document.getElementById("layout-menu") && (isHorizontalLayout = document.getElementById("layout-menu").classList.contains("menu-horizontal")),
  function () {
    ...
    document.getElementById("layout-menu") && function (e, t) {
      let s = null;
      e.onmouseenter = function () {
        s = Helpers.isSmallScreen() ? setTimeout(t, 0) : setTimeout(t, 300)
      }
        ,
    ...
    if (window.templateCustomizer && s) {
      ...
      "light" === o ? (e.classList.add("bx-sun"),
        new bootstrap.Tooltip(e, {
          title: "Light Mode",
          fallbackPlacements: ["bottom"]
        })) : "dark" === o ? (e.classList.add("bx-moon"),
          new bootstrap.Tooltip(e, {
            title: "Dark Mode",
            fallbackPlacements: ["bottom"]
          })) : (e.classList.add("bx-desktop"),
            new bootstrap.Tooltip(e, {
              title: "System Mode",
              fallbackPlacements: ["bottom"]
            }))
    ...
    var a;
    "system" === (a = o) && (a = window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"),
      [].slice.call(document.querySelectorAll("[data-app-" + a + "-img]")).map((function (e) {
        const t = e.getAttribute("data-app-" + a + "-img");
    ...
    if (r && (window.innerWidth < window.Helpers.LAYOUT_BREAKPOINT ? window.Helpers.setNavbarFixed("fixed") : window.Helpers.setNavbarFixed("")),
      window.addEventListener("resize", (function (e) {
        window.innerWidth >= window.Helpers.LAYOUT_BREAKPOINT && document.querySelector(".search-input-wrapper") && (document.querySelector(".search-input-wrapper").classList.add("d-none"),
          ...
          r && (window.innerWidth < window.Helpers.LAYOUT_BREAKPOINT ? window.Helpers.setNavbarFixed("fixed") : window.Helpers.setNavbarFixed(""),
            setTimeout((function () {
  ...
  "undefined" != typeof $ && $((function () {
    ...
    if (e.length && e.on("click", (function () {
      ...
      $(document).on("keydown", (function (e) {
        let o = e.ctrlKey
          , a = 191 === e.which;
        o && a && t.length && (t.toggleClass("d-none"),
          s.focus())
      }
      )),
      setTimeout((function () {
        ...
        s.on("focus", (function () {
          t.hasClass("container-xxl") ? (t.find(e).addClass("container-xxl"),
            e.removeClass("container-fluid")) : t.hasClass("container-fluid") && (t.find(e).addClass("container-fluid"),
        ...
        s.typeahead({
          ...
          templates: {
            ...
            suggestion: function ({ url: e, icon: t, name: s }) {
              return '<a href="' + baseUrl + e + '"><div><i class="bx ' + t + ' me-2"></i><span class="align-middle">' + s + "</span></div></a>"
            },
          ...
          templates: {
            ...
            suggestion: function ({ src: e, name: t, subtitle: s, meta: o }) {
              return '<a href="javascript:;"><div class="d-flex w-50"><img class="me-3" src="' + assetsPath + e + '" alt="' + t + '" height="32"><div class="w-75"><h6 class="mb-0">' + t + '</h6><small class="text-muted">' + s + '</small></div></div><small class="text-muted">' + o + "</small></a>"
            },
          ...
          s.on("keyup", (function () {
            "" == s.val() && o.addClass("fade").removeClass("show")
          }
          ))
      }
      )),
