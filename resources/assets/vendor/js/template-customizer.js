!function (t, e) {
  ...
  return function () {
          ...
          return e.toString = function () {
            ...
            e.i = function (t, i, s) {
              ...
              for (var r = 0; r < t.length; r++) {
                var l = [].concat(t[r]);
                s && a[l[0]] || (i && (l[2] ? l[2] = "".concat(i, " and ").concat(l[2]) : l[2] = i),
                  e.push(l))
              }
            }
            ,
        ...
        function m(t, e, i, s) {
          ...
          if (t.styleSheet)
            ...
            o[e] && t.removeChild(o[e]),
              o.length ? t.insertBefore(n, o[e]) : t.appendChild(n)
          }
        }
        function h(t, e, i) {
          var s = i.css
            , a = i.media
            , n = i.sourceMap;
          if (a ? t.setAttribute("media", a) : t.removeAttribute("media"),
    ...
    return function () {
      ...
      function c(t, e) {
        for (var i = 0; i < e.length; i++) {
          ...
          s.enumerable = s.enumerable || !1,
            ...
            Object.defineProperty(t, u(s.key), s)
        }
      }
      function u(t) {
        var e = function (t, e) {
      ...
      var d, m = ["rtl", "style", "headerType", "contentLayout", "layoutCollapsed", "showDropdownOnHover", "layoutNavbarOptions", "layoutFooterFixed", "themes"], h = ["light", "dark", "system"], p = ["sticky", "static", "hidden"], y = document.documentElement.classList;
      ...
      var v = document.getElementsByTagName("HTML")[0].getAttribute("data-theme") || 0
        ...
        , b = !!y.contains("layout-menu-collapsed")
        , _ = d
        , S = y.contains("layout-wide") ? "wide" : "compact"
        , z = !!y.contains("layout-footer-fixed")
        ...
        , w = function () {
          function t(e) {
            var i = e.cssPath
              ...
              , y = e.defaultNavbarType
              , w = e.defaultFooterFixed
              , C = e.styles
              , k = e.navbarOptions
              , T = e.defaultStyle
              , N = e.availableContentLayouts
              , L = e.availableDirections
              , A = e.availableStyles
              , O = e.availableThemes
            ...
            if (function (t, e) {
              ...
              if (this.settings = {},
                ...
                this.settings.controls = o || m,
                this.settings.defaultTextDir = "rtl" === r || g,
                this.settings.defaultHeaderType = l || x,
                this.settings.defaultMenuCollapsed = void 0 !== u ? u : b,
                this.settings.defaultContentLayout = void 0 !== c ? c : S,
                this.settings.defaultShowDropdownOnHover = void 0 === d || d,
                this.settings.defaultNavbarType = void 0 !== y ? y : _,
                this.settings.defaultFooterFixed = void 0 !== w ? w : z,
                this.settings.availableDirections = L || t.DIRECTIONS,
                this.settings.availableStyles = A || t.STYLES,
                this.settings.availableThemes = O || t.THEMES,
                this.settings.availableHeaderTypes = I || t.HEADER_TYPES,
                this.settings.availableContentLayouts = N || t.CONTENT,
                this.settings.availableLayouts = E || t.LAYOUTS,
                this.settings.availableNavbarOptions = F || t.NAVBAR_OPTIONS,
                this.settings.defaultTheme = this._getDefaultTheme(void 0 !== D ? D : v),
                this.settings.styles = C || h,
                this.settings.navbarOptions = k || p,
                this.settings.defaultStyle = T || f,
            ...
            i = [{
                ...
                if (this._hasControls("themes")) {
                  ...
                  if (s) {
                    ...
                    this._loadStylesheets((a = {},
                      ...
                      (n = u(n)) in a ? Object.defineProperty(a, n, {
                        value: o,
                        enumerable: !0,
                        configurable: !0,
                        writable: !0
              ...
              value: function () {
                ...
                "" !== i || "" !== s || "" !== a || "" !== n || "" !== o || "" !== l || "" !== u ? this._showResetBtnNotification(!0) : this._showResetBtnNotification(!1),
                  ...
                  this._hasControls("style") || (this.settings.style = y.contains("dark-style") ? "dark" : "light"),
              ...
              value: function () {
                ...
                this._cleanup(),
                  this.container = this._getElementFromString(r());
                ...
                o.addEventListener("click", l),
                  this._listeners.push([o, "click", l]);
                var c = this.container.querySelector(".template-customizer-close-btn")
                  , u = function () {
                ...
                c.addEventListener("click", u),
                  this._listeners.push([c, "click", u]);
                ...
                if (this._hasControls("style")) {
                  ...
                  m.addEventListener("change", h),
                    this._listeners.push([m, "change", h])
                } else
                ...
                if (this._hasControls("themes")) {
                  this.settings.availableThemes.forEach((function (t) {
                    ...
                    var s = i(t.name, t.title, "themeRadios", y.contains("dark-style"), e);
                    v.appendChild(s)
                  }
                  )),
                  ...
                  v.addEventListener("change", f),
                    this._listeners.push([v, "change", f])
                } else
                ...
                if (this._hasControls("rtl headerType contentLayout layoutCollapsed layoutNavbarOptions", !0)) {
                  ...
                  if (this._hasControls("rtl") && rtlSupport) {
                    var S = _.querySelector(".template-customizer-directions-options");
                    this.settings.availableDirections.forEach((function (t) {
                      var e = i(t.name, t.title, "directionRadioIcon", y.contains("dark-style"));
                      S.appendChild(e)
                    }
                    )),
                      S.querySelector('input[value="'.concat(this.settings.rtl ? "rtl" : "ltr", '"]')).setAttribute("checked", "checked");
                    var z = function (e) {
                      t._loadingState(!0),
                    ...
                    S.addEventListener("change", z),
                      this._listeners.push([S, "change", z])
                  } else
                  ...
                  if (this._hasControls("headerType")) {
                    ...
                    C.addEventListener("change", k),
                      this._listeners.push([C, "change", k])
                  } else
                  ...
                  if (this._hasControls("contentLayout")) {
                    ...
                    N.addEventListener("change", L),
                      this._listeners.push([N, "change", L])
                  } else
                    T.parentNode.removeChild(T);
                  ...
                  if (this._hasControls("layoutCollapsed")) {
                    ...
                    O.addEventListener("change", E),
                      this._listeners.push([O, "change", E])
                  } else
                  ...
                  if (this._hasControls("layoutNavbarOptions")) {
                    ...
                    F.addEventListener("change", D),
                      this._listeners.push([F, "change", D])
                  } else
