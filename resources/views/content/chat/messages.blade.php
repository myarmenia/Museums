        ...
        <div class="row container d-flex justify-content-center">
            <div class="card card-bordered">
                <div class="card-header">
                    @if (!$data->visitor)
                        <h4 class="card-title"><strong>Այս հաղորդագրությունը ուղարկվել է չգրանցված օգտատերի կողմից դրա համար պատասխանը կուղարկվի նրա էլ․ հասցեին</strong></h4>
                    @endif
                </div>
                ...
                <div class="publisher bt-1 border-light">
                    ...
                    @if (!isSuperAdmin())
                        <button type="button" class="nav-link" role="tab" ><i class="tf-icons bx bx-table me-1"></i><span class="d-none d-sm-block"> </span></button>
                    @endif
                </div>
            </div>
        </div>
