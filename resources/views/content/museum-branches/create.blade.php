    ...
    <h4 class="py-3 mb-4">
      <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Ստեղծել Մասնաճյուղ</li>
          </ol>
      </nav>
  </h4>
    <div class="card">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h5 class="card-header">Ստեղծել Մասնաճյուղ </h5>
            </div>
        ...
        <div class="card-body">
                  ...
                  <span class="required-field text-danger">*</span>
                    ...
                    <div class="col-md-10">
                        <input class="form-control"
                              ...
                              value="{{ old("translate.$lang.address") }}"
            ...
            @enderror
              ...
              <div class="mb-3 row">
                ...
                <div class="col-md-10">
                    <input class="form-control" placeholder="Մասնաճյուղի հեռախոսահամար" value="{{ old('phone_number') }}"
            ...
            @enderror
              ...
              <div class="mb-3 row">
                ...
                <div class="col-md-10">
                    <input class="form-control" placeholder="Հղում" value="{{ old('link') }}"
                        id="link" name="link" />
                </div>
                @error("link")
                <div class="mb-3 row justify-content-end">
